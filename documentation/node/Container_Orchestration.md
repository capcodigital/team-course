...
Container Orchestration refers to the automated arrangement, coordination, and management of software containers. In this task, you will deploy the Node.js application docker container on to a Kubernetes (K8s) cluster. 
